...
export class Transparencia {
  ...
  // Complete data for the Transparency sections
  protected readonly sections: TransparenciaSection[] = [
    {
      ...
      items: [
        'I.- Redes Sociales Nacionales',
        'II.- Directorio de Redes de Comisiones Estatales'
      ]
    },
    {
      id: 'manifiesto',
    ...
    },
    {
      ...
      items: [
        'I.- Reglamento Nacional',
        'II.- Reglamentos de Comisiones Estatales',
        'III.- Reglamentos de Grupos Operativos',
        'IV.- Reglamentos de Comisiones Temáticas',
        'V.- Reglamentos de Grupo de Transversalidad'
      ]
    },
    {
      id: 'ruta-critica',
      ...
      items: [
        'I.- Ruta Crítica Nacional',
        'II.- Ruta Crítica de Comisiones Estatales',
        'III.- Ruta Crítica de Grupos Operativos',
        'IV.- Ruta Crítica de Comisiones Temáticas',
        'V.- Ruta Crítica de Grupo de Transversalidad'
      ]
    },
    {
      id: 'directorios',
      ...
      items: [
        'I.- Directorio de Comisiones Estatales',
        'II.- Directorio de Grupos Operativos',
        'III.- Directorio de Comisiones Temáticas',
        'IV.- Directorio de Grupo de Transversalidad'
      ]
    },
    {
      id: 'organigrama',
      ...
      items: [
        ...
        'II.- Organigrama de Comisiones Estatales'
      ]
    },
    {
      id: 'sesiones',
      ...
      items: [
        'I.- Sesiones de Comisiones Estatales',
        'II.- Sesiones de Grupos Operativos',
        'III.- Sesiones de Comisiones Temáticas',
        'IV.- Sesiones de Grupo de Transversalidad'
      ]
    },
    {
      id: 'conversatorios',
      ...
      items: [
        'I.- Conversatorios de Comisiones Estatales',
        'II.- Conversatorios de Grupos Operativos',
        'III.- Conversatorios de Comisiones Temáticas',
        'IV.- Conversatorios de Grupo de Transversalidad'
      ]
    },
    {
      id: 'calendario',
      ...
      items: [
        'I.- Calendario de Actividades y Eventos de Comisiones Estatales',
        'II.- Calendario de Actividades y Eventos de Grupos Operativos',
        'III.- Calendario de Actividades y Eventos de Comisiones Temáticas',
        'IV.- Calendario de Actividades y Eventos de Grupo de Transversalidad'
      ]
    },
    {
      id: 'patrimonio',
      ...
      items: [
        'I.- Patrimonio de Nacional',
        'II.- Patrimonio de Comisiones Estatales'
      ]
    },
    {
      id: 'ingresos-egresos',
      ...
      items: [
        'I.- Ingresos Nacionales',
        'II.- Ingresos de Comisiones Estatales',
        'III.- Egresos Nacionales',
        'IV.- Egresos de Comisiones Estatales'
      ]
    },
    {
      ...
      items: [
        'I.- Tramites, Formatos y Manuales Nacionales',
        'II.- Tramites, Formatos y Manuales de Comisiones Estatales'
      ]
    },
    {
      id: 'talleres',
      ...
      items: [
        'I.- Talleres Nacionales',
        'II.- Talleres de Comisiones Estatales'
      ]
    }
  ];
