 ...
 * ─── Zettelkasten ─────────────────────────────────────────────────
 * zk_id:  data-011
 * title:  TRANSPARENCIA.DATA — Secciones del portal de transparencia
 * type:   data
 * tags:   [angular, data, transparency, sections, content]
 * author: lancast
 * created: 2026-06-15
 * updated: 2026-06-15
 * ───────────────────────────────────────────────────────────────────
 *
 * Contenido completo de las secciones del Portal de Transparencia.
 * Extraído de la página transparencia.ts para mantener los datos
...
export interface TransparenciaSection {
  id: string;
  title: string;
  icon: string;
  description: string;
...
export const TRANSPARENCIA_SECTIONS: TransparenciaSection[] = [
  {
    id: 'redes-sociales',
